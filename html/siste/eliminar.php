...
$codigo_a_eliminar = $_POST['usuario'];

// Consulta SQL para eliminar el registro con el código proporcionado
$sql = "DELETE FROM login WHERE usuario = '$codigo_a_eliminar'";

// Ejecutar la consulta
if ($conexion->query($sql) === TRUE) {
    $mensaje = "Usuario eliminado correctamente";
                echo '<script>alert("' . $mensaje . '");</script>';
                echo '<script>window.location.href = "sistemas.php?usuario=' . urlencode($usuario) . '";</script>';
} else {
